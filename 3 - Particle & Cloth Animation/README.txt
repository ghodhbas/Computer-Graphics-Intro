-ODE Integrators: presseing 'e', 'r', 't' switches between the integrators
    Explicit Euler  
    RK4
    Trapezoidal
...
-customizable pendulum System (nb of particles and parameters)

-cloth simulation and animation (press a)